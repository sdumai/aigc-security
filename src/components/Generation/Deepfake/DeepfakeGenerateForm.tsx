  ...
  return (
    ...
    >
      <Form
        form={form}
        layout="vertical"
        className={`deepfake-config-form deepfake-config-layout${functionType === "faceswap" ? " has-model-guide" : ""}`}
        initialValues={{ function: DEEPFAKE_DEFAULT_FUNCTION, model: DEEPFAKE_DEFAULT_MODEL }}
      >
